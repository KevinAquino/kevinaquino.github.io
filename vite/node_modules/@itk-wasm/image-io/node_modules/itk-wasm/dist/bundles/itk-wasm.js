...
// dist/interface-types/pixel-types.js
var PixelTypes = {
  Unknown: "Unknown",
  Scalar: "Scalar",
  RGB: "RGB",
...
// dist/interface-types/image-type.js
var ImageType = class {
  dimension;
  componentType;
  pixelType;
...
// dist/image-shared-buffer-or-copy.js
...
// dist/worker-pool/worker-pool.js
...
// dist/interface-types/point-set-type.js
...
// dist/interface-types/point-set.js
var PointSet = class {
  pointSetType;
  name = "PointSet";
  numberOfPoints;
...
// dist/interface-types/mesh-type.js
var MeshType = class {
  dimension;
  pointComponentType;
  pointPixelComponentType;
...
// dist/interface-types/poly-data-type.js
...
// dist/interface-types/poly-data.js
var PolyData = class {
  polyDataType;
  name = "PolyData";
  numberOfPoints;
...
// dist/interface-types/transform-parameterizations.js
...
// dist/interface-types/transform-type.js
...
// dist/interface-types/transform.js
var Transform = class {
  transformType;
...
// dist/pipeline/create-web-worker.js
...
// dist/pipeline/create-worker-proxy.js
...
// dist/pipeline/internal/load-emscripten-module-main-thread.js
...
// dist/pipeline/pipelines-base-url.js
...
// dist/pipeline/pipelines-query-params.js
...
// dist/pipeline/pipeline-worker-url.js
...
async function loadPipelineModule(pipelinePath, pipelineBaseUrl, pipelineQueryParams) {
  ...
  if (pipelineToModule.has(pipeline)) {
    ...
    const pipelineModule = await load_emscripten_module_main_thread_default(pipelinePath, pipelineBaseUrl?.toString() ?? defaultPipelinesBaseUrl(), pipelineQueryParams ?? defaultPipelinesQueryParams());
...
async function runPipeline(pipelinePath, args, outputs, inputs, options) {
  ...
  const { workerProxy, worker: usedWorker } = await create_worker_proxy_default(worker, pipelineWorkerUrlString, options?.pipelineQueryParams ?? defaultPipelinesQueryParams());
  worker = usedWorker;
  const transferables = [];
  if (!(inputs == null) && inputs.length > 0) {
...
// dist/pipeline/default-web-worker.js
...
// dist/deprecated/read-dicom-tags.js
...
// dist/deprecated/read-dicom-tags-array-buffer.js
...
// dist/deprecated/read-image-dicom-file-series.js
...
// dist/deprecated/read-image-dicom-array-buffer-series.js
...
// dist/deprecated/mesh-to-poly-data.js
...
// dist/deprecated/read-image-blob.js
...
// dist/deprecated/read-image-file.js
...
// dist/deprecated/read-image-file-series.js
...
// dist/deprecated/read-mesh-array-buffer.js
...
// dist/deprecated/read-mesh-file.js
