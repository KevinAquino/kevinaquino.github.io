 ...
 */
async function wasmZstdWriteImageNode(image, serializedImage, options = {}) {
    ...
    const pipelinePath = path.join(path.dirname(fileURLToPath(import.meta.url)), 'pipelines', 'wasm-zstd-write-image');
...
//# sourceMappingURL=wasm-zstd-write-image-node.js.map