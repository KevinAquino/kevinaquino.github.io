 ...
 */
async function hdf5WriteImageNode(image, serializedImage, options = {}) {
    ...
    const pipelinePath = path.join(path.dirname(fileURLToPath(import.meta.url)), 'pipelines', 'hdf5-write-image');
...
//# sourceMappingURL=hdf5-write-image-node.js.map