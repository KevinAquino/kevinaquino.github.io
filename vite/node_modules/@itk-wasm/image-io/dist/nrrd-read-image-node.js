 ...
 */
async function nrrdReadImageNode(serializedImage, options = {}) {
    ...
    const pipelinePath = path.join(path.dirname(fileURLToPath(import.meta.url)), 'pipelines', 'nrrd-read-image');
...
//# sourceMappingURL=nrrd-read-image-node.js.map