 ...
 */
async function wasmWriteImageNode(image, serializedImage, options = {}) {
    ...
    const pipelinePath = path.join(path.dirname(fileURLToPath(import.meta.url)), 'pipelines', 'wasm-write-image');
...
//# sourceMappingURL=wasm-write-image-node.js.map