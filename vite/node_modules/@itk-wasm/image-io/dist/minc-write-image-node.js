 ...
 */
async function mincWriteImageNode(image, serializedImage, options = {}) {
    ...
    const pipelinePath = path.join(path.dirname(fileURLToPath(import.meta.url)), 'pipelines', 'minc-write-image');
...
export default mincWriteImageNode;
//# sourceMappingURL=minc-write-image-node.js.map