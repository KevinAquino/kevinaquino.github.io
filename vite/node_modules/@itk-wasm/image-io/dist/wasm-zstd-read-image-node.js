 ...
 */
async function wasmZstdReadImageNode(serializedImage, options = {}) {
    ...
    const pipelinePath = path.join(path.dirname(fileURLToPath(import.meta.url)), 'pipelines', 'wasm-zstd-read-image');
...
//# sourceMappingURL=wasm-zstd-read-image-node.js.map