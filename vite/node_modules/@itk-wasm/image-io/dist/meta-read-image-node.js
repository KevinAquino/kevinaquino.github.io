 ...
 * @param {MetaReadImageNodeOptions} options - options object
 *
 * @returns {Promise<MetaReadImageNodeResult>} - result object
 */
async function metaReadImageNode(serializedImage, options = {}) {
    ...
    const pipelinePath = path.join(path.dirname(fileURLToPath(import.meta.url)), 'pipelines', 'meta-read-image');
...
export default metaReadImageNode;
//# sourceMappingURL=meta-read-image-node.js.map