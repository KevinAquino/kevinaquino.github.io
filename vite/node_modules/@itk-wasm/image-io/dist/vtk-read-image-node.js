 ...
 */
async function vtkReadImageNode(serializedImage, options = {}) {
    ...
    const pipelinePath = path.join(path.dirname(fileURLToPath(import.meta.url)), 'pipelines', 'vtk-read-image');
...
export default vtkReadImageNode;
//# sourceMappingURL=vtk-read-image-node.js.map