 ...
 */
async function jpegReadImageNode(serializedImage, options = {}) {
    ...
    const pipelinePath = path.join(path.dirname(fileURLToPath(import.meta.url)), 'pipelines', 'jpeg-read-image');
...
//# sourceMappingURL=jpeg-read-image-node.js.map