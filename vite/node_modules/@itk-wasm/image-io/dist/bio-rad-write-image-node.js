 ...
 */
async function bioRadWriteImageNode(image, serializedImage, options = {}) {
    ...
    const pipelinePath = path.join(path.dirname(fileURLToPath(import.meta.url)), 'pipelines', 'bio-rad-write-image');
...
//# sourceMappingURL=bio-rad-write-image-node.js.map