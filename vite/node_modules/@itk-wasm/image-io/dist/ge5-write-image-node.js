 ...
 */
async function ge5WriteImageNode(image, serializedImage, options = {}) {
    ...
    const pipelinePath = path.join(path.dirname(fileURLToPath(import.meta.url)), 'pipelines', 'ge5-write-image');
...
//# sourceMappingURL=ge5-write-image-node.js.map