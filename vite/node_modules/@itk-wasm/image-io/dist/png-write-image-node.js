 ...
 * @param {PngWriteImageNodeOptions} options - options object
 *
 * @returns {Promise<PngWriteImageNodeResult>} - result object
 */
async function pngWriteImageNode(image, serializedImage, options = {}) {
    ...
    const pipelinePath = path.join(path.dirname(fileURLToPath(import.meta.url)), 'pipelines', 'png-write-image');
...
export default pngWriteImageNode;
//# sourceMappingURL=png-write-image-node.js.map