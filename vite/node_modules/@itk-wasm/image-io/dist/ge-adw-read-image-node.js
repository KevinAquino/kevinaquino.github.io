 ...
 */
async function geAdwReadImageNode(serializedImage, options = {}) {
    ...
    const pipelinePath = path.join(path.dirname(fileURLToPath(import.meta.url)), 'pipelines', 'ge-adw-read-image');
...
//# sourceMappingURL=ge-adw-read-image-node.js.map