 ...
 */
async function jpegWriteImageNode(image, serializedImage, options = {}) {
    ...
    const pipelinePath = path.join(path.dirname(fileURLToPath(import.meta.url)), 'pipelines', 'jpeg-write-image');
...
//# sourceMappingURL=jpeg-write-image-node.js.map