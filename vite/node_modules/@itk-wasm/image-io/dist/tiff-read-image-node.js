 ...
 */
async function tiffReadImageNode(serializedImage, options = {}) {
    ...
    const pipelinePath = path.join(path.dirname(fileURLToPath(import.meta.url)), 'pipelines', 'tiff-read-image');
...
export default tiffReadImageNode;
//# sourceMappingURL=tiff-read-image-node.js.map