 ...
 */
async function giplWriteImageNode(image, serializedImage, options = {}) {
    ...
    const pipelinePath = path.join(path.dirname(fileURLToPath(import.meta.url)), 'pipelines', 'gipl-write-image');
...
export default giplWriteImageNode;
//# sourceMappingURL=gipl-write-image-node.js.map