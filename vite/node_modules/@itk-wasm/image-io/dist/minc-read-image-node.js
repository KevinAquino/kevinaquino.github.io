 ...
 */
async function mincReadImageNode(serializedImage, options = {}) {
    ...
    const pipelinePath = path.join(path.dirname(fileURLToPath(import.meta.url)), 'pipelines', 'minc-read-image');
...
export default mincReadImageNode;
//# sourceMappingURL=minc-read-image-node.js.map