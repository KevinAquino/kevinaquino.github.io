 ...
 */
async function ge4ReadImageNode(serializedImage, options = {}) {
    ...
    const pipelinePath = path.join(path.dirname(fileURLToPath(import.meta.url)), 'pipelines', 'ge4-read-image');
...
export default ge4ReadImageNode;
//# sourceMappingURL=ge4-read-image-node.js.map