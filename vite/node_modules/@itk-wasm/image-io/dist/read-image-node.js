 ...
 */
async function readImageNode(serializedImage, options = {}) {
    ...
    if (mimeType && mimeToImageIo.has(mimeType)) {
        ...
        for (const readerWriter of imageIoIndexNode.values()) {
            if (readerWriter[0] !== null) {
                let { couldRead, image } = await readerWriter[0](absoluteFilePath, { informationOnly: options.informationOnly });
                if (couldRead) {
...
//# sourceMappingURL=read-image-node.js.map