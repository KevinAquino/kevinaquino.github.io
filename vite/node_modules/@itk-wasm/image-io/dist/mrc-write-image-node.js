 ...
 */
async function mrcWriteImageNode(image, serializedImage, options = {}) {
    ...
    const pipelinePath = path.join(path.dirname(fileURLToPath(import.meta.url)), 'pipelines', 'mrc-write-image');
...
export default mrcWriteImageNode;
//# sourceMappingURL=mrc-write-image-node.js.map