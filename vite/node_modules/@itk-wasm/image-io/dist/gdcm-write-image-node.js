 ...
 */
async function gdcmWriteImageNode(image, serializedImage, options = {}) {
    ...
    const pipelinePath = path.join(path.dirname(fileURLToPath(import.meta.url)), 'pipelines', 'gdcm-write-image');
...
export default gdcmWriteImageNode;
//# sourceMappingURL=gdcm-write-image-node.js.map