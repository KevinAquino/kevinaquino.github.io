 ...
 */
async function giplReadImageNode(serializedImage, options = {}) {
    ...
    const pipelinePath = path.join(path.dirname(fileURLToPath(import.meta.url)), 'pipelines', 'gipl-read-image');
...
//# sourceMappingURL=gipl-read-image-node.js.map