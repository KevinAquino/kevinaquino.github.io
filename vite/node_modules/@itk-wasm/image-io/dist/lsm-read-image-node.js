 ...
 */
async function lsmReadImageNode(serializedImage, options = {}) {
    ...
    const pipelinePath = path.join(path.dirname(fileURLToPath(import.meta.url)), 'pipelines', 'lsm-read-image');
...
export default lsmReadImageNode;
//# sourceMappingURL=lsm-read-image-node.js.map